 ...
 * translator may freely add, drop, or rearrange (see the architecture doc's
 * Развилка F note on PlaceholderSeverity). \n as "required" is a judgment call,
 * not yet confirmed by the user — flagged there as an open question.
 */
